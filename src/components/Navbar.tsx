...
const Navbar = () => {
    ...
    return (
        <motion.nav
            style={{ opacity: 1 }}
            className={`fixed top-0 w-full z-50 px-6 py-4 ${isDarkMode ? "bg-gray-900" : "bg-white"
        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                >
                    ...
                    <span className={`text-lg ml-1 font-semibold ${isDarkMode ? "text-gray-400" : "text-gray-900"}`}>Kalz</span>
                </motion.div>
                ...
                <div className="hidden md:flex items-center space-x-8">
                    {["Home", "Skills", "Projects", "About"].map((item) => (
                        <motion.button
                            ...
                            onClick={() => scrollToSection(item === "Projects" ? "projects" : item === "About" ? "journey" : item.toLowerCase())}
                        >
                            {item}
                        </motion.button>
                    ))}
                    <motion.button
                        ...
                        className={`p-2 rounded-full transition-colors ${isDarkMode ? "text-gray-400 hover:text-white bg-gray-900" : "text-gray-600 hover:text-gray-900 hover:bg-gray-200"
                            }`}
                    >
                ...
                <div className="md:hidden flex items-center space-x-4">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => setIsDarkMode(isDarkMode ? "light" : "dark")}
                        className={`p-2 rounded-full transition-colors ${isDarkMode ? "text-gray-400 hover:text-white bg-gray-800" : "text-gray-600 hover:text-gray-900 hover:bg-gray-200"
                            }`}
                    >
