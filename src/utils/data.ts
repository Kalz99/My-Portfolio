...
export const SKILLS_CATEGORIES = [
    {
        ...
        skills:[
            ...
            {name:"Typescript", level:90,color:"bg-green-500"},
            {name:"Tailwind CSS", level:85,color:"bg-red-500"},
            {name:"Svelte", level:80,color:"bg-orange-500"},
        ],
    },
    {
        title: "Backend",
        ...
        skills:[
            ...
            {name:"Express", level:85,color:"bg-green-500"},
            {name:"Python", level:80,color:"bg-red-500"},
            {name:"Django", level:75,color:"bg-orange-500"},
        ],
    },
    {
        title: "Database",
    ...
    },
    {
        ...
        skills:[
            ...
            {name:"AWS", level:75,color:"bg-red-500"},
            {name:"Azure", level:70,color:"bg-orange-500"},
        ],
    },
];
